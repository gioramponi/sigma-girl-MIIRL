...
class CategoricalPdType(PdType):
    ...
    def pdfromlatent(self, latent_vector, init_scale=1.0, init_bias=0.0,
                     trainable_variance=True, trainable_bias=True, init_logstd=0.,clip=None):
...
class DiagGaussianPdType(PdType):
    ...
    def pdfromlatent(self, latent_vector, init_scale=1.0,
                     init_bias=0.0, trainable_variance=True,
                     init_logstd=0., trainable_bias=True,
                     clip=None):
        ...
        logstd = tf.get_variable(name='pi/logstd', shape=[1, self.size],
                                 initializer=tf.constant_initializer(value=init_logstd), trainable=trainable_variance)
...
class BernoulliPdType(PdType):
    ...
    def sample_dtype(self):
        return tf.int32
    def pdfromlatent(self, latent_vector, init_scale=1.0, init_bias=0.0,
                     trainable_variance=True, init_logstd=0.,clip=None,
                     trainable_bias=True):
